...
P2P_CLASSIFIER_INSTRUCTIONS = (
    ...
    "and bank payment-link products. The monobank_jar_payments field is a legacy "
    "name for all such products. Set monobank_jar_payments=true only when the "
    "merchant asks for payment through a Monobank jar/banka, a Monobank savings "
    "jar link, A-Bank collection/fundraiser/zbir/sbor link, PrivatBank envelope/"
    "konvert link, or instructions like 'Nakapychennia -> Banka', 'Banka po "
    "ssylke', 'send/share/copy the banka link', 'send A-Bank zbir link', or "
    "'Privat konvert link'. "
    ...
    "3) чи потрібно платити через банківський продукт із посиланням: "
    "Monobank «банку», A-Bank «збір» або PrivatBank «конверт». "
    ...
    "third_party_payments=false. Якщо доказів недостатньо, також поверни false. "
        ...
        "input": [
            {
                ...
                "content": (
                    ...
                    "bank payment-link product: Monobank jar/banka or jar link, A-Bank "
                    "collection/fundraiser/zbir/sbor link, or PrivatBank envelope/konvert "
                    "link. "
